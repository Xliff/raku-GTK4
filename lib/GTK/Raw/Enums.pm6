...
constant GtkEventControllerScrollFlags is export := guint32;
our enum GtkEventControllerScrollFlagsEnum is export (
  ...
  GTK_EVENT_CONTROLLER_SCROLL_BOTH_AXES  => 1 +| 1 +< 1 #= (GTK_EVENT_CONTROLLER_SCROLL_VERTICAL | GTK_EVENT_CONTROLLER_SCROLL_HORIZONTAL),
);
