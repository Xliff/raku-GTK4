...
unit package GTK::Raw::IconView:ver<4>;

### /usr/src/gtk4/gtk/deprecated/gtkiconview.h

sub gtk_icon_view_create_drag_icon (
...
sub gtk_icon_view_get_item_column (
  GtkIconView $icon_view,
  GtkTreePath $path
)
  returns gint
...
sub gtk_icon_view_get_path_at_pos (
  GtkIconView $icon_view,
  gint        $x,
  gint        $y
)
...
sub gtk_icon_view_path_is_selected (GtkIconView $icon_view, GtkTreePath $path)
  returns uint32
  is      native(gtk4)
  is      export
{ * }
...
sub gtk_icon_view_set_item_width (
  GtkIconView $icon_view,
  gint        $item_width
)
  is      native(gtk4)
...
sub gtk_icon_view_set_markup_column (
  GtkIconView $icon_view,
  gint        $column
)
  is      native(gtk4)
...
sub gtk_icon_view_set_pixbuf_column (
  GtkIconView $icon_view,
  gint        $column
)
  is      native(gtk4)
...
sub gtk_icon_view_set_row_spacing (
  GtkIconView $icon_view,
  gint        $row_spacing
)
  is      native(gtk4)
...
sub gtk_icon_view_set_text_column (
  GtkIconView $icon_view,
  gint        $column
)
  is      native(gtk4)
...
sub gtk_icon_view_set_tooltip_column (
  GtkIconView $icon_view,
  gint        $column
)
  is      native(gtk4)
