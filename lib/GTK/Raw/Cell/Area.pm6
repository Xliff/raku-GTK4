...
### /usr/src/gtk4/gtk/deprecated/gtkcellarea.h
...
sub gtk_cell_area_foreach (
  GtkCellArea $area,
              &callback (GtkCellRenderer, gpointer),
...
sub gtk_cell_area_stop_editing (
  GtkCellArea $area,
  gboolean    $canceled
)
  is      native(gtk4)
